		...
		<div class="jumbotron" style="padding: 5% 8%;">
			...
			<form>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input name="birthDate" type="date" class="form-control" id="staticEmail"
							value="${udb.formatDate }">
					</div>
				</div>
				<hr class="my-4">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input name="address" type="text" class="form-control" id="staticEmail"
							value="${udb.address }">
					</div>
				</div>
				<hr class="my-4">
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<input name="loginId" type="text" class="form-control" id="staticEmail"
							value="${udb.loginId }">
					</div>
				</div>
				...
				<div class="row justify-content-md-center">
					<div class="col col-lg-6">
						<a
							href="file:///C:/Users/USER/Documents/PersonalDevelopment/PersonalMock/userInfoChangeConfirm.html"><button
								type="button" class="btn btn-primary btn-block">更新</button></a>
					</div>
				</div>
			</form>
		</div>
